...
var availableMediaTypes = ['text/html', 'text/plain', 'application/json', 'application/xml'];
...
function showAlumnos(req,resp) {
	...
	switch (mediaType) {
	case 'text/plain': 
		alumnos.text(req,resp);
		break;
	case 'application/xml': 
		alumnos.xml(req,resp);
		break;
	case 'application/json': 
		alumnos.json(req,resp);
		break;
	case 'text/html':
	default:
		alumnos.html(req,resp);	
	}
}
...
function crearAlumno(post,req,resp) {
    alumnos.insertaAlumno(post.nombre, post.edad, function(err,alumnos) {
